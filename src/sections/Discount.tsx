  ...
  return (
    <section className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          className="mt-16 bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-8 text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            Want to stay updated on new offers?
          </h3>
          <p className="text-gray-600 mb-6">
            Subscribe to our newsletter and never miss a special discount
          </p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              type="email"
              placeholder="Enter your email"
              className="flex-1 px-6 py-3 rounded-full border-2 border-blue-200 focus:border-blue-600 focus:outline-none"
            />
            <motion.button
              className="bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition-colors font-semibold whitespace-nowrap"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Subscribe
